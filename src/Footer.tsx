  ...
  return (
    <footer className="border-t border-slate-200 px-4 md:px-8 py-6 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-wrap justify-center gap-32 md:gap-48 mb-4">
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="#"
                  className="text-slate-600 hover:text-teal-600 transition-all duration-200 text-sm hover:translate-x-1"
                >
                  Documentation
                </a>
              </li>
