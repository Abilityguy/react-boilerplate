            ...
            <div className="max-w-7xl mx-auto space-y-8">
                <div className="space-y-6 animate-in fade-in duration-1000">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center pt-2 mx-auto">
                        {/* The buttons are now full-width on mobile and centered */}
                        <Button
                            asChild
                            className="w-full sm:w-auto px-8 py-4 text-lg font-semibold transition-all duration-300 hover:scale-105 hover:shadow-xl shadow-lg rounded-xl !bg-teal-600 hover:!bg-teal-700 !text-white !border-none"
                        >
                            <Link
                                target="_blank"
                                to="https://docs.google.com/forms/d/e/1FAIpQLSe53hy4yfldHsOd2HTyG6xHr-lS3iLUS4Ysad0kA-frlQdmUQ/viewform?usp=dialog"
                            >
                                Download ARX
                        ...
                        <Button
                            variant="outline"
                            asChild
                            className="w-full sm:w-auto px-8 py-4 text-lg font-semibold border-2 border-slate-300 hover:bg-slate-50 hover:text-slate-700 hover:border-teal-500 transition-all duration-300 hover:scale-105 text-slate-700 bg-white rounded-xl shadow-lg hover:shadow-xl"
                        >
                ...
                <div className="flex items-center justify-center">
                    <div className="relative bg-white rounded-2xl shadow-lg border border-slate-200 w-full max-w-[720px]">
                        <div className="relative overflow-hidden p-2 sm:p-4 aspect-video">
